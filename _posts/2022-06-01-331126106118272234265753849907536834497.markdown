...
The authors present a tool which detects these instances via template pattern matching. They found around 200 bugs in the Linux kernel and OpenBSD, mostly related to null pointers.
...
- [Here we go again: why is it difficult for developers to learn another programming language?](TODO:)
- [“A Pace Not Dictated by Electrons”: An Empirical Study of Work Without Email](TODO:)
- [Bugs as Deviant Behavior: A General Approach to Inferring Errors in Systems Code](TODO:)
